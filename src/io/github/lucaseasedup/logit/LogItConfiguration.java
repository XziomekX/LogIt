...
public final class LogItConfiguration
{
    ...
    public void load()
    {
        ...
        plugin.getConfig().set("waiting-room.newbie-teleport.enabled",           plugin.getConfig().getBoolean("waiting-room.newbie-teleport.enabled", false));
        plugin.getConfig().set("waiting-room.newbie-teleport.location.world",    plugin.getConfig().getString("waiting-room.newbie-teleport.location.world", "world"));
