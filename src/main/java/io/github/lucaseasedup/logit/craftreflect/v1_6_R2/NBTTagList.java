...
public class NBTTagList extends io.github.lucaseasedup.logit.craftreflect.NBTTagList
{
    ...
    {
        net.minecraft.server.v1_6_R2.NBTBase.a(getThis(), d);
    }
    
    @Override
    public void add(io.github.lucaseasedup.logit.craftreflect.NBTBase nbtb)
    {
        getThis().add((net.minecraft.server.v1_6_R2.NBTBase) nbtb.getHolder().get());
    }
    ...
    private net.minecraft.server.v1_6_R2.NBTTagList getThis()
    {
        return (net.minecraft.server.v1_6_R2.NBTTagList) getHolder().get();
    }
}
