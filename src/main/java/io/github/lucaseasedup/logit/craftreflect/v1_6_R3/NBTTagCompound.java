...
public class NBTTagCompound extends io.github.lucaseasedup.logit.craftreflect.NBTTagCompound
{
    ...
    {
        super(new net.minecraft.server.v1_6_R3.NBTTagCompound());
    }
    ...
    private net.minecraft.server.v1_6_R3.NBTTagCompound getThis()
    {
        return (net.minecraft.server.v1_6_R3.NBTTagCompound) getHolder().get();
    }
}
