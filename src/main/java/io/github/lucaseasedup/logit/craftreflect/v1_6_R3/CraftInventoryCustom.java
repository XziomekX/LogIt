...
public class CraftInventoryCustom extends io.github.lucaseasedup.logit.craftreflect.CraftInventoryCustom
{
    ...
    {
        super(new org.bukkit.craftbukkit.v1_6_R3.inventory.CraftInventoryCustom(null, size));
    }
    ...
    private org.bukkit.craftbukkit.v1_6_R3.inventory.CraftInventoryCustom getThis()
    {
        return (org.bukkit.craftbukkit.v1_6_R3.inventory.CraftInventoryCustom) getHolder().get();
    }
}
